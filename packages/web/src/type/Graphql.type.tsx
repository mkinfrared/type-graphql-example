...
export type AllFilmsQuery = { __typename?: "Query" } & {
  allFilms: Array<
    { __typename?: "Film" } & Pick<
      Film,
      "id" | "title" | "director" | "producers"
    >
  >;
};
...
`;
export type AllFilmsComponentProps = Omit<
...
export const AllFilmsComponent = (props: AllFilmsComponentProps) => (
  <ApolloReactComponents.Query<AllFilmsQuery, AllFilmsQueryVariables>
    query={AllFilmsDocument}
    {...props}
  />
);

export type AllFilmsProps<TChildProps = {}> = ApolloReactHoc.DataProps<
  AllFilmsQuery,
  AllFilmsQueryVariables
> &
  TChildProps;
export function withAllFilms<TProps, TChildProps = {}>(
  operationOptions?: ApolloReactHoc.OperationOption<
    TProps,
    AllFilmsQuery,
    AllFilmsQueryVariables,
    AllFilmsProps<TChildProps>
  >
) {
...
export function useAllFilmsQuery(
  ...
  return ApolloReactHooks.useQuery<AllFilmsQuery, AllFilmsQueryVariables>(
    AllFilmsDocument,
    baseOptions
  );
}
export function useAllFilmsLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<AllFilmsQuery, AllFilmsQueryVariables>(
    AllFilmsDocument,
    baseOptions
  );
}
...
export type AllFilmsQueryResult = ApolloReactCommon.QueryResult<
  AllFilmsQuery,
  AllFilmsQueryVariables
>;
